...
SOFTPWM_DEFINE_CHANNEL(0, DDRD, PORTD, PORTD2);  // Pin 2
SOFTPWM_DEFINE_CHANNEL(1, DDRD, PORTD, PORTD3);  // Pin 3
SOFTPWM_DEFINE_CHANNEL(2, DDRD, PORTD, PORTD4);  // Pin 4
SOFTPWM_DEFINE_CHANNEL(3, DDRD, PORTD, PORTD5);  // Pin 5
SOFTPWM_DEFINE_CHANNEL(4, DDRD, PORTD, PORTD6);  // Pin 6
SOFTPWM_DEFINE_CHANNEL(5, DDRD, PORTD, PORTD7);  // Pin 7
SOFTPWM_DEFINE_CHANNEL(6, DDRB, PORTB, PORTB0);  // Pin 8
SOFTPWM_DEFINE_CHANNEL(7, DDRB, PORTB, PORTB1);  // Pin 9
SOFTPWM_DEFINE_CHANNEL(8, DDRB, PORTB, PORTB2);  // Pin 10
SOFTPWM_DEFINE_CHANNEL(9, DDRB, PORTB, PORTB3);  // Pin 11
SOFTPWM_DEFINE_CHANNEL(10, DDRB, PORTB, PORTB4); // Pin 12
SOFTPWM_DEFINE_CHANNEL(11, DDRC, PORTC, PORTC1); // Pin A1
SOFTPWM_DEFINE_CHANNEL(12, DDRC, PORTC, PORTC2); // Pin A2
